...
public class NodeObject{
	...
	public Job job;
    int numberOfColumns;	
    public FileType type;  // 0.. db-Node 1.. WAL-Node 2.. Journal-Node
	...
	public NodeObject(String name, VBox tablePane, int numberOfColumns, FileType type, int tabletype, boolean isTable)
	{
		this.name = name;
